...
//    #elif defined(__AVR_ATmega4809__) // Every and UNO Rev2 have different mappings regarding A0...A7
        ...
        #warning "Debug-Ports active ATtiny"
        #define MODE_TP1 pinMode( PIN_PA4, OUTPUT )
        #define SET_TP1 PORTA.OUTSET = PIN4_bm
        #define CLR_TP1 PORTA.OUTCLR = PIN4_bm
        #define MODE_TP2 pinMode( PIN_PA5, OUTPUT )
        #define SET_TP2 PORTA.OUTSET = PIN5_bm
        #define CLR_TP2 PORTA.OUTCLR = PIN5_bm
        #define MODE_TP3
        #define SET_TP3
        #define CLR_TP3
        #define MODE_TP4
